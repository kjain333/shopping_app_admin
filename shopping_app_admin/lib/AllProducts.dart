...
class _AllProducts extends State<AllProducts>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () async{
            Navigator.push(context, MaterialPageRoute(builder: (context)=>Forms())).whenComplete((){
              setState(() {
              });
            });
          },
              ...
              return Stack(
                children: <Widget>[
                  ...
                  Positioned(
                      ...
                      child: Container(
                          width: MediaQuery.of(context).size.width,
                          height: MediaQuery.of(context).size.height-((expanded)?160:40),
                          ...
                          child: Column(
                            children: <Widget>[
                              Container(
                                  height: MediaQuery.of(context).size.height-((expanded)?210:150),
                                  width: MediaQuery.of(context).size.width,
                                  child: SingleChildScrollView(
                                    child: Wrap(
  ...
  Widget MyData(QueryDocumentSnapshot querydata){
    ...
    return (flag==0)?Container(height: 0,width: 0,):GestureDetector(
      ...
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context)=>EditProduct(querydata, querydata.id))).then((value){
          setState(() {
          });
        });
      },
